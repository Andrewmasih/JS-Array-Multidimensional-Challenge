...
1/ All varibles must be named correctly and have the correct values.

2/ your 'indexArray' will be tested to ensure that we can use its value to access 15 in the 'multidimensionalArray' 
